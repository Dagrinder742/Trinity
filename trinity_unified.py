...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            time.sleep(5)
# 1. Append the navi widget init to your .bashrc
echo 'eval "$(navi widget bash)"' >> ~/.bashrc

# 2. Source your bashrc to apply the changes immediately
source ~/.bashrc

# 3. Create a directory for your personal custom cheatsheets
mkdir -p ~/.local/share/navi/cheats

# 4. Test the installation by launching navi
navi
